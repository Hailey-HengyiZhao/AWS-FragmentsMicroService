/*
 * This is the Memory Database Model that supports many functions such as
 * GET: passing primaryKey and secondaryKey then return the Promise.resolve with value( with validation )
 * PUT: passing primaryKey and secondaryKey then set the value and return Promise.resolve
 * QUERY: passing primaryKey then return the existing db of the value, return Promise.resolve
 * DELETE: passing primaryKey and secondaryKey then  return a Promise.resolve and delete the db 
 */
